...
process.on("uncaughtException", function (err) {
	...
	console.error(err);
	console.log("Smart Mirror will not quit, but it might be a good idea to check why this happened. Maybe no internet connection?");
	});
	...
	var loadModule = function(module, callback) {
		...
		if (loadModule) {
			...
			if (m.requiresVersion) {
				console.log("Check Smart Mirror version for node helper '" + moduleName + "' - Minimum version:  " + m.requiresVersion + " - Current version: " + global.version);
